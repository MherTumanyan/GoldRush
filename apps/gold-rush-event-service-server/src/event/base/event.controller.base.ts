...
import { BucketFindManyArgs } from "../../bucket/base/BucketFindManyArgs";
...
export class EventControllerBase {
  ...
  async findBuckets(
    ...
    const query = plainToClass(BucketFindManyArgs, request.query);
    const results = await this.service.findBuckets(params.id, {
      ...query,
      select: {
        createdAt: true,
  ...
  @common.Post("/:id/buckets")
  @nestAccessControl.UseRoles({
    resource: "Event",
    action: "update",
    possession: "any",
  })
  async connectBuckets(
    @common.Param() params: EventWhereUniqueInput,
    @common.Body() body: BucketWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      buckets: {
        connect: body,
  ...
  @common.Delete("/:id/buckets")
  @nestAccessControl.UseRoles({
    resource: "Event",
    action: "update",
    possession: "any",
  })
  async disconnectBuckets(
    @common.Param() params: EventWhereUniqueInput,
    @common.Body() body: BucketWhereUniqueInput[]
  ): Promise<void> {
    const data = {
